...
export default function TasksScreen() {
  ...
  // Filter tasks by courseId first if specified
  const courseFilteredTasks = selectedCourseId
      ...
      >
        ...
        >
          <Text style={[styles.filterText, filter === 'all' && styles.filterTextActive]}>
            All ({courseFilteredTasks.length})
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          <Text style={[styles.filterText, filter === 'pending' && styles.filterTextActive]}>
            Pending ({courseFilteredTasks.filter(t => t.status !== TaskStatus.COMPLETED).length})
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          <Text style={[styles.filterText, filter === 'completed' && styles.filterTextActive]}>
            Completed ({courseFilteredTasks.filter(t => t.status === TaskStatus.COMPLETED).length})
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          <Text style={[styles.filterText, filter === 'overdue' && styles.filterTextActive]}>
            Overdue ({courseFilteredTasks.filter(t => new Date(t.dueDate) < new Date() && t.status !== TaskStatus.COMPLETED).length})
          </Text>
        </TouchableOpacity>
      </ScrollView>
